...
import svgPaths from "./svg-q2u9zfjdni";
import imgImage1 from "../../assets/d85674a76031f2d7c6433d1e9e7fe062294a2ddd.png";
    ...
    <div className="bg-white relative shrink-0 w-full" data-name="Container">
      <div className="content-stretch flex flex-col gap-[20px] items-start pb-[45px] pt-[15px] px-[20px] relative w-full">
        <div className="content-stretch flex flex-col gap-[10px] items-center relative shrink-0 w-full" data-name="Phone_Item">
          <Frame4 />
          <p className="font-['Barlow_Condensed',sans-serif] font-medium tracking-[-0.02em] leading-[normal] not-italic relative shrink-0 text-[24px] text-black tracking-[-0.48px] w-full">Type F</p>
        </div>
        <p className="font-['Noto_Sans_JP:Light',sans-serif] font-light leading-[22px] min-w-full relative shrink-0 text-[11px] text-black tracking-[0.22px] w-[min-content]">
          近代都市における「公共性」が、いかに個人のフェティシズムを去勢し、均質的な記号空間へと変質させたかを論じる 。アレント的な公的領域の崩壊後、人々が「不自由な社会」の中でいかに代替的な愛着対象を捏造し、自己を擬態させているかを鋭く抉る政治哲学の野心的試論 。<br aria-hidden="true" />
          という体のブックカバー。
        </p>
...
export default function PhoneTypeF() {
  return (
    <div className="bg-black content-stretch flex flex-col items-center overflow-x-hidden pt-[54px] relative size-full min-w-0 max-w-full" data-name="Phone_TypeF">
      <Container />
