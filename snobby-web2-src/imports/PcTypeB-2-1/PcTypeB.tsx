...
import svgPaths from "./svg-ill174a51x";
import imgImage8 from "../../assets/ddaf5fd981ce79d1036782c7975f966b502396ab.png";
  ...
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0 w-full" data-name="About Section">
      ...
      <div className="font-['Noto_Sans_JP:Light',sans-serif] font-light leading-[0] min-w-full relative shrink-0 text-[13px] tracking-[0.26px] w-[min-content]">
        <p className="leading-[30px] mb-0">日本人の美徳とされる「察し」や「空気を読む」文化を、高度な自己監視システムとして再定義。和の精神がいかにして個の欲望を去勢し、洗練された「不自由」を完成させたのかを、歴史的資料から鋭く考察する。西洋的な自由主義とは異なる、東洋的な服従の美学を説いた異色の日本人論。</p>
    ...
    <div className="bg-white relative shrink-0 w-full" data-name="Container">
      <div className="content-stretch flex gap-[30px] items-start pb-[60px] pt-[45px] px-[45px] relative w-full">
        <div className="content-stretch flex flex-[1_0_0] flex-col gap-[30px] items-start min-h-px min-w-px relative" data-name="Book Cover">
          <Frame2 />
          <p className="font-['Barlow_Condensed',sans-serif] font-medium tracking-[-0.02em] leading-[normal] relative shrink-0 text-[48px] text-black tracking-[-0.48px] w-full">Type B</p>
        </div>
        <InformationSection />
      </div>
    </div>
...
export default function PcTypeB() {
  return (
    <div className="bg-black content-stretch flex flex-col items-center overflow-x-hidden pt-[66px] relative size-full min-w-0 max-w-full" data-name="PC_TypeB">
      <Container />
