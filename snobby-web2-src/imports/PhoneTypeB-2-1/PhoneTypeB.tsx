...
import svgPaths from "./svg-jah2um0gm2";
import imgImage1 from "../../assets/ddaf5fd981ce79d1036782c7975f966b502396ab.png";
    ...
    <div className="bg-white relative shrink-0 w-full" data-name="Container">
      <div className="content-stretch flex flex-col gap-[20px] items-start pb-[45px] pt-[15px] px-[20px] relative w-full">
        <div className="content-stretch flex flex-col gap-[10px] items-center relative shrink-0 w-full" data-name="Phone_Item">
          <Frame4 />
          <p className="font-['Barlow_Condensed',sans-serif] font-medium tracking-[-0.02em] leading-[normal] relative shrink-0 text-[24px] text-black tracking-[-0.24px] w-full">Type B</p>
        </div>
        <p className="font-['Noto_Sans_JP:Light',sans-serif] font-light leading-[22px] min-w-full relative shrink-0 text-[11px] text-black tracking-[0.22px] w-[min-content]">
          日本人の美徳とされる「察し」や「空気を読む」文化を、高度な自己監視システムとして再定義。和の精神がいかにして個の欲望を去勢し、洗練された「不自由」を完成させたのかを、歴史的資料から鋭く考察する。西洋的な自由主義とは異なる、東洋的な服従の美学を説いた異色の日本人論。
          <br aria-hidden="true" />
          という体のブックカバー。
        </p>
...
export default function PhoneTypeB() {
  return (
    <div className="bg-black content-stretch flex flex-col items-center overflow-x-hidden pt-[54px] relative size-full min-w-0 max-w-full" data-name="Phone_TypeB">
      <Container />
