...
import svgPaths from "./svg-7lura2m7jj";
  ...
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0 w-full" data-name="About Section">
      ...
      <div className="font-['Noto_Sans_JP:Light',sans-serif] font-light leading-[0] min-w-full relative shrink-0 text-[13px] tracking-[0.26px] w-[min-content]">
        <p className="leading-[30px] mb-0">中世の王権崩壊を舞台に、沈黙することすら許されない「自由という名の牢獄」に囚われた狂王の末路を描く未発見の悲劇。言語以前の根源的な叫びを、詩的な韻律の中に封じ込めた本作は、近代演劇の源流でありながら、現代の管理社会における個人の無力さを予見している。</p>
    ...
    <div className="bg-white relative shrink-0 w-full" data-name="Container">
      <div className="content-stretch flex gap-[30px] items-start pb-[60px] pt-[45px] px-[45px] relative w-full">
        <div className="content-stretch flex flex-[1_0_0] flex-col gap-[30px] items-start min-h-px min-w-px relative" data-name="Book Cover">
          <Frame2 />
          <p className="font-['Barlow_Condensed',sans-serif] font-medium tracking-[-0.02em] leading-[normal] not-italic relative shrink-0 text-[48px] text-black tracking-[-0.96px] w-full">Type H</p>
        </div>
        <InformationSection />
      </div>
    </div>
...
export default function PcTypeH() {
  return (
    <div className="bg-black content-stretch flex flex-col items-center overflow-x-hidden pt-[66px] relative size-full min-w-0 max-w-full" data-name="PC_TypeH">
      <Container />
