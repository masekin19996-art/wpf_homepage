...
import svgPaths from "./svg-w9ksoh39qg";
...
function Frame8() {
  return (
    <div className="content-stretch flex flex-col gap-[30px] items-start relative shrink-0 text-black w-full">
      <Frame2 />
      <Frame3 />
    </div>
  );
...
function Frame5() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col h-full items-start justify-between min-h-px min-w-px relative">
      <Frame8 />
      <button className="bg-[#002daa] cursor-pointer relative shrink-0 w-full" data-name="PC_pull-down-button">
          ...
          <div className="content-stretch flex gap-[10px] items-center justify-center px-[16px] py-[10px] relative w-full">
            ...
            <div className="flex items-center justify-center relative shrink-0">
              <div className="-scale-y-100 flex-none">
                <div className="content-stretch flex flex-col items-center justify-center relative" data-name="PC_arrow-down">
                  <div className="flex items-center justify-center relative shrink-0">
...
function Frame() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[10px] h-full items-start min-h-px min-w-px relative text-black">
...
function Frame4() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[30px] items-start min-h-px min-w-px relative self-stretch">
      <Frame5 />
      <Frame />
    </div>
  );
  ...
  return (
    <div className="bg-white relative shrink-0 w-full">
      <div className="content-stretch flex gap-[30px] items-start pb-[60px] pt-[45px] px-[45px] relative w-full">
        <div className="content-stretch flex flex-[1_0_0] flex-col gap-[30px] items-start min-h-px min-w-px relative" data-name="PC_Item">
          <Frame9 />
...
function Component() {
  return (
    <Link href="/" className="h-[50px] block shrink-0 w-[337px]" data-name="_レイヤー_1">
...
export default function PcTypeA() {
  return (
    <div className="bg-black content-stretch flex flex-col items-center pt-[105px] relative size-full" data-name="PC_TypeA">
      ...
      <div className="fixed top-0 left-0 right-0 z-50 flex items-center justify-center overflow-hidden" data-name="Navbar">
        <div className="bg-black content-stretch flex flex-col items-center overflow-visible pb-[25px] pt-[30px] w-[1728px]">
          <Component />
        </div>
      </div>
    </div>
