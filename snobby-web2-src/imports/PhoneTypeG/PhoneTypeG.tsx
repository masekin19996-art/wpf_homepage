...
import svgPaths from "./svg-wvxzsxk4nv";
import imgImage1 from "../../assets/02793cc22d98336be15c201cd980361daa39d989.png";
    ...
    <div className="bg-white relative shrink-0 w-full" data-name="Container">
      <div className="content-stretch flex flex-col gap-[20px] items-start pb-[45px] pt-[15px] px-[20px] relative w-full">
        <div className="content-stretch flex flex-col gap-[10px] items-center relative shrink-0 w-full" data-name="Phone_Item">
          <Frame4 />
          <p className="font-['Barlow_Condensed',sans-serif] font-medium tracking-[-0.02em] leading-[normal] not-italic relative shrink-0 text-[24px] text-black tracking-[-0.48px] w-full">Type G</p>
        </div>
        <p className="font-['Noto_Sans_JP:Light',sans-serif] font-light leading-[22px] min-w-full relative shrink-0 text-[11px] text-black tracking-[0.22px] w-[min-content]">
          アートが美術館という特権的空間を離れ、情報の断片として社会の深層を漂流する時代の表現論。物理的な作品の「美」ではなく、人々の意識の中に「架空の現実」を構築し、既存の価値観を書き換えるための扇動的かつ実験的な手法を提示する。複製技術時代の先にある、情報の伝播そのものを作品化する「ミーム的芸術」の可能性を論じた現代の芸術聖典。
          <br aria-hidden="true" />
          という体のブックカバー。
        </p>
...
export default function PhoneTypeG() {
  return (
    <div className="bg-black content-stretch flex flex-col items-center overflow-x-hidden pt-[54px] relative size-full min-w-0 max-w-full" data-name="Phone_TypeG">
      <Container />
