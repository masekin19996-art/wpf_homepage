...
import svgPaths from "./svg-zn0pw466co";
import imgImage1 from "../../assets/dabfc8b57e524b6c032d31a63968dc88b0c4ddcc.png";
    ...
    <div className="bg-white relative shrink-0 w-full" data-name="Container">
      <div className="content-stretch flex flex-col gap-[20px] items-start pb-[45px] pt-[15px] px-[20px] relative w-full">
        <div className="content-stretch flex flex-col gap-[10px] items-center relative shrink-0 w-full" data-name="Phone_Item">
          <Frame4 />
          <p className="font-['Barlow_Condensed',sans-serif] font-medium tracking-[-0.02em] leading-[normal] relative shrink-0 text-[24px] text-black tracking-[-0.24px] w-full">Type C</p>
        </div>
        <p className="font-['Noto_Sans_JP:Light',sans-serif] font-light leading-[22px] min-w-full relative shrink-0 text-[11px] text-black tracking-[0.22px] w-[min-content]">
          貨幣や商品が物理的実体を失い、デジタル空間上の「物語」や「ミーム」へと収斂していく過程を鋭く分析。欲望が実体的な所有から切り離された現代において、新たな権力勾配はいかにして形成され、個人の意識はどのように領土化されていくのか。実体経済の終焉と、情報の流動性が生み出す新しい階級社会の姿を予見した、21世紀のエコノミスト必読の書。
          <br aria-hidden="true" />
          という体のブックカバー。
        </p>
...
export default function PhoneTypeC() {
  return (
    <div className="bg-black content-stretch flex flex-col items-center overflow-x-hidden pt-[54px] relative size-full min-w-0 max-w-full" data-name="Phone_TypeC">
      <Container />
