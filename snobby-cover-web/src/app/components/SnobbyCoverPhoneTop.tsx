...
function Container4() {
  return (
    <div className="content-stretch flex gap-[15px] items-start relative shrink-0 w-full" data-name="Container">
      <Link to="/type/a" className="content-stretch flex flex-[1_0_0] flex-col gap-[10px] items-start min-h-px min-w-px relative cursor-pointer transition-all duration-300 hover:brightness-90 active:opacity-70" data-name="Collection Item">
        <Frame4 />
      ...
      <Link to="/type/b" className="content-stretch flex flex-[1_0_0] flex-col gap-[10px] items-start min-h-px min-w-px relative cursor-pointer transition-all duration-300 hover:brightness-90 active:opacity-70" data-name="Collection Item">
        <Frame6 />
...
function Container5() {
  return (
    <div className="content-stretch flex gap-[15px] items-start relative shrink-0 w-full" data-name="Container">
      <Link to="/type/c" className="content-stretch flex flex-[1_0_0] flex-col gap-[10px] items-start min-h-px min-w-px relative cursor-pointer transition-all duration-300 hover:brightness-90 active:opacity-70" data-name="Collection Item">
        <Frame7 />
      ...
      <Link to="/type/d" className="content-stretch flex flex-[1_0_0] flex-col gap-[10px] items-start min-h-px min-w-px relative cursor-pointer transition-all duration-300 hover:brightness-90 active:opacity-70" data-name="Collection Item">
        <Frame8 />
...
function Container6() {
  return (
    <div className="content-stretch flex gap-[15px] items-start relative shrink-0 w-full" data-name="Container">
      <Link to="/type/e" className="content-stretch flex flex-[1_0_0] flex-col gap-[10px] items-start min-h-px min-w-px relative cursor-pointer transition-all duration-300 hover:brightness-90 active:opacity-70" data-name="Collection Item">
        <Frame9 />
      ...
      <Link to="/type/f" className="content-stretch flex flex-[1_0_0] flex-col gap-[10px] items-start min-h-px min-w-px relative cursor-pointer transition-all duration-300 hover:brightness-90 active:opacity-70" data-name="Collection Item">
        <Frame10 />
...
function Container7() {
  return (
    <div className="content-stretch flex gap-[15px] items-start relative shrink-0 w-full" data-name="Container">
      <Link to="/type/g" className="content-stretch flex flex-[1_0_0] flex-col gap-[10px] items-start min-h-px min-w-px relative cursor-pointer transition-all duration-300 hover:brightness-90 active:opacity-70" data-name="Collection Item">
        <Frame11 />
      ...
      <Link to="/type/h" className="content-stretch flex flex-[1_0_0] flex-col gap-[10px] items-start min-h-px min-w-px relative cursor-pointer transition-all duration-300 hover:brightness-90 active:opacity-70" data-name="Collection Item">
        <Frame12 />
