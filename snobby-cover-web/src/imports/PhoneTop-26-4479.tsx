...
function Frame2() {
  return (
    <div className="absolute content-stretch flex gap-[90.48px] items-center left-0 top-0 animate-scroll-left-mobile">
      <div className="h-[85.454px] relative shadow-[0px_2.011px_2.011px_0px_rgba(0,0,0,0.25)] shrink-0 w-[55.293px]" data-name="image 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgImage1} />
      </div>
      <div className="h-[85.454px] relative shadow-[0px_2.011px_2.011px_0px_rgba(0,0,0,0.25)] shrink-0 w-[55.293px]" data-name="image 2">
...
function Frame3() {
  return (
    <div className="absolute content-stretch flex gap-[90.48px] items-center left-[-1271.75px] top-0 animate-scroll-right-mobile">
      <div className="h-[85.29px] relative shadow-[0px_2.007px_2.007px_0px_rgba(0,0,0,0.25)] shrink-0 w-[55.18px]" data-name="image 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgImage1} />
      </div>
      <div className="h-[85.29px] relative shadow-[0px_2.007px_2.007px_0px_rgba(0,0,0,0.25)] shrink-0 w-[55.18px]" data-name="image 2">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgImage2} />
      </div>
      <div className="h-[85.29px] relative shadow-[0px_2.007px_2.007px_0px_rgba(0,0,0,0.25)] shrink-0 w-[55.18px]" data-name="image 2">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgImage3} />
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Container">
      <div className="content-stretch flex flex-col gap-[40px] items-start leading-[0] pt-[55px] px-[40px] relative w-full">
        <PhoneLogoComponent />
        <div className="font-['Shippori_Mincho',sans-serif] min-w-full not-italic relative shrink-0 text-[13px] text-white tracking-[0.26px] w-[min-content]">
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Container">
      <div className="content-stretch flex flex-col gap-[30px] items-start px-[15px] py-[30px] relative w-full">
        <p className="font-['Barlow_Condensed',sans-serif] font-medium tracking-[-0.02em] leading-[normal] relative shrink-0 text-[30px] text-white tracking-[-0.3px] uppercase whitespace-nowrap">Collection</p>
        <CollectionContainer />
