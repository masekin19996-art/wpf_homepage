...
import imgImage1 from "figma:asset/d85674a76031f2d7c6433d1e9e7fe062294a2ddd.png";
...
export default function PhoneTypeF() {
  return (
    <div className="bg-black content-stretch flex flex-col items-center pt-[105px] relative size-full" data-name="Phone_TypeF">
      <Container />
