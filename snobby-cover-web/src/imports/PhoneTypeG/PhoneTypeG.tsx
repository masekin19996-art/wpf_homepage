...
import imgImage1 from "figma:asset/02793cc22d98336be15c201cd980361daa39d989.png";
...
export default function PhoneTypeG() {
  return (
    <div className="bg-black content-stretch flex flex-col items-center pt-[105px] relative size-full" data-name="Phone_TypeG">
      <Container />
