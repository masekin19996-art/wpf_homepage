import svgPaths from "./svg-wukmftf1ag";
...
export default function Container() {
  return (
    <div className="content-stretch flex flex-col items-center justify-between py-[30px] relative size-full" data-name="Container">
