import svgPaths from "./svg-obda88hvhe";
...
function Container() {
  return (
    <div className="content-stretch flex flex-col h-[1080px] items-center justify-between py-[30px] relative shrink-0 w-full" data-name="Container">
  ...
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative" data-name="Container">
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col font-['Hiragino_Mincho_Pro:W3',sans-serif] gap-[30px] items-start justify-center not-italic p-[90px] relative text-white w-full">
  ...
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative self-stretch" data-name="Container">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col items-center justify-center pr-[30px] relative size-full">
...
function StoryContainer() {
  return (
    <div className="bg-[#002daa] content-stretch flex items-start relative shrink-0 w-full" data-name="Story Container">
      <Container2 />
      <Container3 />
    </div>
  );
...
function CollectionItemsRow() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0 w-full" data-name="Collection Items Row 1">
      <Link to="/type/a" className="content-stretch flex flex-[1_0_0] flex-col gap-[10px] h-[424px] items-center min-h-px min-w-px relative cursor-pointer hover:opacity-80 transition-opacity">
        <Frame4 />
      ...
      <Link to="/type/b" className="content-stretch flex flex-[1_0_0] flex-col gap-[10px] h-[424px] items-center min-h-px min-w-px relative cursor-pointer hover:opacity-80 transition-opacity">
        <Frame5 />
      ...
      <Link to="/type/c" className="content-stretch flex flex-[1_0_0] flex-col gap-[10px] h-[424px] items-center min-h-px min-w-px relative cursor-pointer hover:opacity-80 transition-opacity">
        <Frame6 />
      ...
      <Link to="/type/d" className="content-stretch flex flex-[1_0_0] flex-col gap-[10px] h-[424px] items-center min-h-px min-w-px relative cursor-pointer hover:opacity-80 transition-opacity" data-name="Item">
        <Frame7 />
...
function CollectionItemsRow1() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0 w-full" data-name="Collection Items Row 2">
      <Link to="/type/e" className="content-stretch flex flex-[1_0_0] flex-col gap-[10px] h-[424px] items-center min-h-px min-w-px relative cursor-pointer hover:opacity-80 transition-opacity">
        <Frame8 />
      ...
      <Link to="/type/f" className="content-stretch flex flex-[1_0_0] flex-col gap-[10px] h-[424px] items-center min-h-px min-w-px relative cursor-pointer hover:opacity-80 transition-opacity">
        <Frame9 />
      ...
      <Link to="/type/g" className="content-stretch flex flex-[1_0_0] flex-col gap-[10px] h-[424px] items-center min-h-px min-w-px relative cursor-pointer hover:opacity-80 transition-opacity">
        <Frame10 />
      ...
      <Link to="/type/h" className="content-stretch flex flex-[1_0_0] flex-col gap-[10px] h-[424px] items-center min-h-px min-w-px relative cursor-pointer hover:opacity-80 transition-opacity" data-name="Item">
        <Frame11 />
...
export default function PcTop() {
  return (
    <div className="content-stretch flex flex-col items-center relative size-full bg-transparent" data-name="PC_TOP">
      <HeroContainer />
      <Container1 />
      <Container4 />
