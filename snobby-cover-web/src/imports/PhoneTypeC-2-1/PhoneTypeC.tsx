...
import imgImage1 from "figma:asset/dabfc8b57e524b6c032d31a63968dc88b0c4ddcc.png";
...
export default function PhoneTypeC() {
  return (
    <div className="bg-black content-stretch flex flex-col items-center pt-[105px] relative size-full" data-name="Phone_TypeC">
      <Container />
