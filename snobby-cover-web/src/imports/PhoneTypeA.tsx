  ...
  return (
    <div className="bg-white relative shrink-0 w-full">
      <div className="content-stretch flex flex-col gap-[15px] items-start pb-[45px] pt-[15px] px-[20px] relative w-full">
        ...
        <button className="bg-[#002daa] content-stretch cursor-pointer flex gap-[10px] items-center justify-center overflow-clip px-[16px] py-[10px] relative shrink-0 w-[300px]" data-name="Phone_pull-down-button">
          ...
          <div className="flex items-center justify-center relative shrink-0">
            <div className="-scale-y-100 flex-none">
              <div className="content-stretch flex flex-col items-center justify-center relative" data-name="Phone_arrow-down">
                <div className="flex items-center justify-center relative shrink-0">
...
function Component() {
  return (
    <Link to="/" className="h-[35px] block shrink-0 w-[237px]" data-name="_レイヤー_1">
...
export default function PhoneTypeA() {
  return (
    <div className="bg-black content-stretch flex flex-col items-center pt-[105px] relative size-full" data-name="Phone_TypeA">
      ...
      <div className="fixed top-0 left-0 right-0 z-50 flex items-center justify-center overflow-hidden" data-name="Phone_Header">
        <div className="bg-black content-stretch flex flex-col items-center overflow-visible pb-[11px] pt-[60px] w-[500px]">
          <Component />
        </div>
      </div>
    </div>
