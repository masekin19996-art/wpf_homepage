import svgPaths from "./svg-4x2ubmp1xa";
...
function Frame2() {
  return (
    <div className="absolute content-stretch flex gap-[90.48px] items-center left-0 top-0 animate-scroll-left-mobile">
      <div className="h-[85.454px] relative shrink-0 w-[55.293px]" data-name="image 1">
        <div className="absolute inset-0 shadow-[0px_2.011px_2.011px_0px_rgba(0,0,0,0.25)]" data-name="image 1">
          <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgImage1} />
        </div>
      </div>
      <div className="h-[85.454px] relative shrink-0 w-[55.293px]" data-name="image 2">
        <div className="absolute aspect-[319/494] left-0 right-0 shadow-[0px_2.011px_2.011px_0px_rgba(0,0,0,0.25)] top-0" data-name="image 2">
          <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgImage2} />
        </div>
      </div>
      <div className="h-[85.454px] relative shrink-0 w-[55.293px]" data-name="image 3">
        <div className="absolute aspect-[319/494] left-0 right-0 shadow-[0px_2.011px_2.011px_0px_rgba(0,0,0,0.25)] top-0" data-name="image 2">
          <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgImage3} />
        </div>
      </div>
      <div className="h-[85.454px] relative shrink-0 w-[55.293px]" data-name="image 4">
        <div className="absolute aspect-[319/494] left-0 right-0 shadow-[0px_2.011px_2.011px_0px_rgba(0,0,0,0.25)] top-0" data-name="image 2">
          <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgImage4} />
        </div>
      </div>
      <div className="h-[85.454px] relative shrink-0 w-[55.293px]" data-name="image 5">
        <div className="absolute aspect-[319/494] left-0 right-0 shadow-[0px_2.011px_2.011px_0px_rgba(0,0,0,0.25)] top-0" data-name="image 2">
          <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgImage5} />
        </div>
      </div>
      <div className="h-[85.454px] relative shrink-0 w-[55.293px]" data-name="image 6">
        <div className="absolute aspect-[319/494] left-0 right-0 shadow-[0px_2.011px_2.011px_0px_rgba(0,0,0,0.25)] top-0" data-name="image 2">
          <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgImage6} />
        </div>
      </div>
      <div className="h-[85.454px] relative shrink-0 w-[55.293px]" data-name="image 7">
        <div className="absolute aspect-[319/494] left-0 right-0 shadow-[0px_2.011px_2.011px_0px_rgba(0,0,0,0.25)] top-0" data-name="image 2">
          <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgImage7} />
        </div>
      </div>
      <div className="h-[85.454px] relative shrink-0 w-[55.293px]" data-name="image 8">
        <div className="absolute aspect-[319/494] left-0 right-0 shadow-[0px_2.011px_2.011px_0px_rgba(0,0,0,0.25)] top-0" data-name="image 2">
          <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgImage8} />
        </div>
      </div>
      <div className="h-[85.454px] relative shrink-0 w-[55.293px]" data-name="image 9">
        <div className="absolute inset-0 shadow-[0px_2.011px_2.011px_0px_rgba(0,0,0,0.25)]" data-name="image 1">
          <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgImage1} />
        </div>
      </div>
      <div className="h-[85.454px] relative shrink-0 w-[55.293px]" data-name="image 10">
        <div className="absolute aspect-[319/494] left-0 right-0 shadow-[0px_2.011px_2.011px_0px_rgba(0,0,0,0.25)] top-0" data-name="image 2">
          <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgImage2} />
        </div>
      </div>
      <div className="h-[85.454px] relative shrink-0 w-[55.293px]" data-name="image 11">
        <div className="absolute aspect-[319/494] left-0 right-0 shadow-[0px_2.011px_2.011px_0px_rgba(0,0,0,0.25)] top-0" data-name="image 2">
          <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgImage3} />
        </div>
      </div>
      <div className="h-[85.454px] relative shrink-0 w-[55.293px]" data-name="image 12">
        <div className="absolute aspect-[319/494] left-0 right-0 shadow-[0px_2.011px_2.011px_0px_rgba(0,0,0,0.25)] top-0" data-name="image 2">
          <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgImage4} />
        </div>
      </div>
      <div className="h-[85.454px] relative shrink-0 w-[55.293px]" data-name="image 13">
        <div className="absolute aspect-[319/494] left-0 right-0 shadow-[0px_2.011px_2.011px_0px_rgba(0,0,0,0.25)] top-0" data-name="image 2">
          <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgImage5} />
        </div>
      </div>
      <div className="h-[85.454px] relative shrink-0 w-[55.293px]" data-name="image 14">
        <div className="absolute aspect-[319/494] left-0 right-0 shadow-[0px_2.011px_2.011px_0px_rgba(0,0,0,0.25)] top-0" data-name="image 2">
          <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgImage6} />
        </div>
      </div>
      <div className="h-[85.454px] relative shrink-0 w-[55.293px]" data-name="image 15">
        <div className="absolute aspect-[319/494] left-0 right-0 shadow-[0px_2.011px_2.011px_0px_rgba(0,0,0,0.25)] top-0" data-name="image 2">
          <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgImage7} />
        </div>
      </div>
      <div className="h-[85.454px] relative shrink-0 w-[55.293px]" data-name="image 16">
        <div className="absolute aspect-[319/494] left-0 right-0 shadow-[0px_2.011px_2.011px_0px_rgba(0,0,0,0.25)] top-0" data-name="image 2">
          <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgImage8} />
        </div>
      </div>
...
function Container() {
  return (
    <div className="content-stretch flex flex-col h-[649px] items-center justify-between py-[30px] relative shrink-0 w-[1300px]" data-name="Container">
      <div className="h-[85.454px] overflow-clip relative shrink-0 w-[970.149px]" data-name="UpperStream">
        <Frame2 />
      </div>
      <Navbar />
      <div className="h-[85.454px] overflow-clip relative shrink-0 w-[970.149px]" data-name="LowerStream">
        <Frame3 />
      </div>
    </div>
  );
...
function StoryContainer() {
  return (
    <div className="bg-[#002daa] content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Story Container">
      <Container2 />
...
function Frame4() {
  return (
    <div className="aspect-[400/385] bg-[#f6f6f6] content-stretch flex items-center justify-center relative shrink-0 w-full">
...
function Frame5() {
  return (
    <div className="content-stretch flex gap-[15px] items-start relative shrink-0 w-full">
      <Link to="/type/a" className="content-stretch flex flex-[1_0_0] flex-col gap-[10px] items-start min-h-px min-w-px relative cursor-pointer active:opacity-70 transition-opacity" data-name="Collection Item">
        <Frame4 />
      ...
      <Link to="/type/b" className="content-stretch flex flex-[1_0_0] flex-col gap-[10px] items-start min-h-px min-w-px relative cursor-pointer active:opacity-70 transition-opacity" data-name="Collection Item">
        <Frame6 />
...
function Frame7() {
  return (
    <div className="content-stretch flex gap-[15px] items-start relative shrink-0 w-full">
      <Link to="/type/c" className="content-stretch flex flex-[1_0_0] flex-col gap-[10px] items-start min-h-px min-w-px relative cursor-pointer active:opacity-70 transition-opacity" data-name="Collection Item">
        <Frame8 />
      ...
      <Link to="/type/d" className="content-stretch flex flex-[1_0_0] flex-col gap-[10px] items-start min-h-px min-w-px relative cursor-pointer active:opacity-70 transition-opacity" data-name="Collection Item">
        <Frame9 />
...
function Frame10() {
  return (
    <div className="content-stretch flex gap-[15px] items-start relative shrink-0 w-full">
      <Link to="/type/e" className="content-stretch flex flex-[1_0_0] flex-col gap-[10px] items-start min-h-px min-w-px relative cursor-pointer active:opacity-70 transition-opacity" data-name="Collection Item">
        <Frame11 />
      ...
      <Link to="/type/f" className="content-stretch flex flex-[1_0_0] flex-col gap-[10px] items-start min-h-px min-w-px relative cursor-pointer active:opacity-70 transition-opacity" data-name="Collection Item">
        <Frame12 />
...
function Frame13() {
  return (
    <div className="content-stretch flex gap-[15px] items-start relative shrink-0 w-full">
      <Link to="/type/g" className="content-stretch flex flex-[1_0_0] flex-col gap-[10px] items-start min-h-px min-w-px relative cursor-pointer active:opacity-70 transition-opacity" data-name="Collection Item">
        <Frame14 />
      ...
      <Link to="/type/h" className="content-stretch flex flex-[1_0_0] flex-col gap-[10px] items-start min-h-px min-w-px relative cursor-pointer active:opacity-70 transition-opacity" data-name="Collection Item">
        <Frame15 />
...
export default function PhoneTop() {
  return (
    <div className="content-stretch flex flex-col items-center pt-[45px] relative size-full bg-transparent" data-name="Phone_TOP">
      <Container />
      <Container1 />
      <Container3 />
