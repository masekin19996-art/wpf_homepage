...
import imgImage1 from "figma:asset/ddaf5fd981ce79d1036782c7975f966b502396ab.png";
...
export default function PhoneTypeB() {
  return (
    <div className="bg-black content-stretch flex flex-col items-center pt-[105px] relative size-full" data-name="Phone_TypeB">
      <Container />
