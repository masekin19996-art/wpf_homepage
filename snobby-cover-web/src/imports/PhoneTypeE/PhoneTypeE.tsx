...
import imgImage1 from "figma:asset/216527f26b77a26dc101fee4191cdf3117f91333.png";
...
export default function PhoneTypeE() {
  return (
    <div className="bg-black content-stretch flex flex-col items-center pt-[105px] relative size-full" data-name="Phone_TypeE">
      <Container />
