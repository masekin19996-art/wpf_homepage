import svgPaths from "./svg-0wk2c3saho";
...
function Container() {
  return (
    <div className="content-stretch flex flex-col h-[1080px] items-center justify-between py-[30px] relative shrink-0 w-full" data-name="Container">
      <div className="h-[200px] overflow-clip relative shrink-0 w-full" data-name="frame36">
        <Frame2 />
      </div>
      <Navbar />
      <div className="h-[200px] overflow-clip relative shrink-0 w-full" data-name="frame36">
  ...
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative self-stretch" data-name="Container">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col items-center justify-center pl-[30px] pr-[100px] py-[50px] relative size-full">
          <div className="aspect-[674/525] flex-[1_0_0] min-h-px min-w-px relative" data-name="page_flip_animation_1 1">
...
function CollectionItemsRow() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0 w-full" data-name="Collection Items Row 1">
      <div className="content-stretch flex flex-[1_0_0] flex-col gap-[10px] h-[424px] items-center min-h-px min-w-px relative rounded-[10px]" data-name="PcItems">
        <Frame4 />
