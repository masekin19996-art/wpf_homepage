import svgPaths from "./svg-h7epip4l2j";
...
export default function Container() {
  return (
    <div className="content-stretch flex flex-col items-center justify-between py-[30px] relative h-screen w-full" data-name="Container">
