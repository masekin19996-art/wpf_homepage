...
import imgImage8 from "figma:asset/31bf7224a75dc4cf12b1b54f930f5c6fcd1c865a.png";
...
export default function PcTypeD() {
  return (
    <div className="bg-black content-stretch flex flex-col items-center pt-[105px] relative size-full" data-name="PC_TypeD">
      <Container />
