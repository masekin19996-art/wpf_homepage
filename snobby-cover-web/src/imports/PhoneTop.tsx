import svgPaths from "./svg-fsk1rapnl0";
...
function Container2() {
  return (
    <div className="bg-[#002daa] relative shrink-0 w-full" data-name="Container">
      <div className="content-stretch flex flex-col font-['Hiragino_Mincho_Pro:W3',sans-serif] gap-[15px] items-start not-italic p-[30px] relative text-white w-full">
        ...
        <div className="leading-[0] relative shrink-0 text-[12px] tracking-[0.24px] w-full">
          ...
          <p className="leading-[24px] mb-0">しかしこのサイトを見ているあなたはきっと、ものの10分で読書に飽きて、Instagramの通知ひとつで目線はスマホに移ってしまうだろう。</p>
          <p className="leading-[24px] mb-0">そのままでは電車で見かけたその人のように、文化的で知的な魅力を手にすることは永遠にできない。</p>
          <p className="leading-[24px] mb-0">でももう大丈夫。ここで自分の読みたい漫画や雑誌のサイズに合ったブックカバーを印刷して被せて仕舞えば、あなたはいつでもどこでも漫画や雑誌を読みながら「賢い人」になれる。</p>
          <p className="leading-[24px]">あなたも賢くなって、知的な魅力を演出しませんか？</p>
        </div>
      </div>
    </div>
  );
...
function Container3() {
  return (
    <div className="bg-black content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
...
function StoryContainer() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0 w-full" data-name="Story Container">
      <Container2 />
      <Container3 />
    </div>
  );
...
function Frame5() {
  return (
    <div className="content-stretch flex gap-[15px] items-start relative shrink-0 w-full">
      <div className="content-stretch flex flex-[1_0_0] flex-col gap-[10px] items-start min-h-px min-w-px relative" data-name="Collection Item">
        <Frame4 />
  ...
  return (
    <div className="content-stretch flex flex-col items-center pt-[45px] relative size-full" data-name="Phone_TOP">
      <video autoPlay className="absolute max-w-none object-cover size-full" controlsList="nodownload" loop playsInline>
        <source src="/_videos/v1/15b6b4456dc3d6fea745344ab616ccb42710329b" />
      </video>
      <Container />
      <Container1 />
      <Container4 />
