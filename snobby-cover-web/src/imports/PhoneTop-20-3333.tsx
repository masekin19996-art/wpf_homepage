import svgPaths from "./svg-y4jj3d55yp";
...
import imgPageFlipAnimation11 from "../assets/16a460214cc94501b5cc5ddc0d961f99b240f024.png";
...
function Container() {
  return (
    <div className="content-stretch flex flex-col h-[649px] items-center justify-between py-[30px] relative shrink-0 w-[1300px]" data-name="Container">
      <div className="h-[100px] overflow-clip relative shrink-0 w-[970.149px]" data-name="frame36">
        <Frame2 />
      </div>
      <Navbar />
      <div className="h-[100px] overflow-clip relative shrink-0 w-[970.149px]" data-name="frame36">
